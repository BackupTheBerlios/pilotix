...
public class ServerBall extends Ball {
	...
	/*
	 * NEW -Collision:oui-> REMOVE -Traitement-> supprime ADD -Collision:oui->
	 * TO_REMOVE -Traitement-> REMOVE NORMAL -Collision:oui-> TO_REMOVE
	 * -Traitement-> REMOVE
	 * 
	 * NEW -Collision:non-> NEW -Traitement-> ADD ADD -Collision:non-> ADD
	 * -Traitement-> NORMAL NORMAL -Collision:non-> NORMAL -Traitement-> NORMAL
	 * 
	 * REMOVE -Collision:pas-> REMOVE -Traitement-> supprime
	 * 
	 * explication : exemple avec la première ligne : si la balle est dans
	 * l'état NEW et qu'elle subit une collision (collision:oui) elle passe dans
	 * l'état REMOVE, le traitement (qui est une machine d'état déterministe) la
	 * supprimera.
	 * 
