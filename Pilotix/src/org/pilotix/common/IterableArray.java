 ...
 * bi-directionnel reliant toutes ses cases non vides.
 * 
 * Il est possible d'insérer n'importe où dans le tableau.
 * 
 * Pour de bonnes performances il sera nécessaire d'effectuer des insertions
 * avant le premier élement non vide du tableau, ou après le dernier.
 * 
...
public class IterableArray {
	 ...
	 */
	/*
	 * public void cursor1OnLast() { current = last; }
	 */
	...
	/*
	 * public Object cursor1getAndStepNext() { Object result = objects[current];
	 * current = next[current]; return result; }
	 */

	/*
	 * public Object cursor1getAndStepPrev() { Object result = objects[current];
	 * current = prev[current]; return result; }
	 */
	 ...
	 */
	/*
	 * public void setCursor2OnLast() { current2 = last; }
	 */
	...
	/*
	 * public boolean cursor2hasPrev() { return current2 != -1; }
	 */

	/*
	 * public Object cursor2getAndStepNext() { Object result =
	 * objects[current2]; current2 = next[current2]; return result; }
	 * 
	 * public Object cursor2getAndStepPrev() { Object result =
	 * objects[current2]; current2 = prev[current2]; return result; }
	 */
...
//	}
	...
	/*
	 * public static void main(String[] args) { IterableArray ia2 = new
	 * IterableArray(10); System.out.println("Test de IterrableArray"); try {
	 * ia2.afficherEtat(); ia2.add(5,"Cinq"); ia2.afficherEtat();
	 * ia2.add(2,"Deux"); ia2.afficherEtat(); ia2.add(8,"Huit");
	 * ia2.afficherEtat(); ia2.add(7,"Sept"); ia2.afficherEtat();
	 * ia2.add(0,"Zero"); ia2.afficherEtat(); ia2.remove(8); ia2.afficherEtat();
	 * ia2.remove(0); ia2.afficherEtat(); ia2.remove(5); ia2.afficherEtat();
	 * 
	 * ia2.setCursorOnFirst(); while (ia2.hasNext()) {
	 * System.out.print(ia2.next()); } System.out.println();
	 * 
	 * ia2.setCursorOnLast(); while (ia2.hasPrev()) {
	 * System.out.print(ia2.prev()); } System.out.println();
	 * 
	 * System.out.println("Un"); ia2.add(1, "Un");
	 * System.out.println(ia2.get(1)); ia2.afficherEtat();
	 * System.out.println("-"); ia2.clear();
	 * 
	 * System.out.println("UnDeux"); ia2.add(1, "Un"); ia2.add(2, "Deux");
	 * ia2.setCursorOnFirst(); while (ia2.hasNext()) {
	 * System.out.print(ia2.next()); } ia2.afficherEtat();
	 * System.out.println("\n-"); ia2.clear();
	 * 
	 * System.out.println("UnTrois"); ia2.add(1, "Un"); ia2.add(2, "Deux");
	 * ia2.remove(2); ia2.add(3, "Trois"); ia2.setCursorOnFirst(); while
	 * (ia2.hasNext()) { System.out.print(ia2.next()); } ia2.afficherEtat();
	 * System.out.println("\n-"); ia2.clear();
	 * 
	 * System.out.println("TroisDeuxUn"); ia2.add(1, "Un"); ia2.add(2, "Deux");
	 * ia2.add(3, "Trois"); ia2.setCursorOnLast(); while (ia2.hasPrev()) {
	 * System.out.print(ia2.prev()); } ia2.afficherEtat();
	 * System.out.println("\n-"); ia2.clear();
	 * 
	 * System.out.println("UnTroisCinqSept"); ia2.add(1, "Un");
	 * ia2.afficherEtat(); ia2.add(7, "Sept"); ia2.afficherEtat(); ia2.add(3,
	 * "Trois"); ia2.afficherEtat(); ia2.add(5, "Cinq"); ia2.afficherEtat();
	 * ia2.setCursorOnFirst(); while (ia2.hasNext()) {
	 * System.out.print(ia2.next()); } //ia2.afficherEtat();
	 * System.out.println("\n-"); ia2.clear(); } catch (Exception e) {
	 * e.printStackTrace(); } }
	 */
}
