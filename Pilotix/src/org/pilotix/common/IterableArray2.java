 ...
 * avec IterrableArray (qui va prochainement etre mis au grenier!), est qu'il
...
public class IterableArray2 {
	...
	public IterableArray2(int nbmax) {
	...
	public Object get(int index) {//throws Exception {
		/*
		 * if (isFree[index]) throw new Exception("IterableArray already
		 * empty"); else
		 */
