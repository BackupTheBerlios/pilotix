...
public class ClientArea extends org.pilotix.common.Area {
	...
	public void setArea(String aAreaFile) {
		Document document = Environment.theXMLHandler.getDocumentFromURL(Environment.theRL.getResource(ResourceLocator.AREA, aAreaFile));
		...
		for (int i = 0; i < theObstacles.getLength(); i++) {
			...
			obstacles.add(i, new Obstacle(new Vector(Integer.parseInt(tmpXmlObstacle.getAttribute("upLeftCornerX")), Integer.parseInt(tmpXmlObstacle.getAttribute("upLeftCornerY"))), new Vector(Integer.parseInt(tmpXmlObstacle.getAttribute("downRightCornerX")), Integer.parseInt(tmpXmlObstacle.getAttribute("downRightCornerY"))), Integer.parseInt(tmpXmlObstacle.getAttribute("height")), Integer.parseInt(tmpXmlObstacle.getAttribute("altitude")), tmpXmlObstacle.getAttribute("topTexture"), tmpXmlObstacle.getAttribute("sideTexture")));
		}
	}
	...
	public class Obstacle {
		...
		public Obstacle(Vector upLeftCorner, Vector downRightCorner, int height, int altitude, String topTexture, String sideTexture) {
	...
	/**
	 * Met à jour la position de certains éléments qui ne sont pas mis à jour à
	 * chaque frame par le serveur (position des balles par exemple).
	 */
